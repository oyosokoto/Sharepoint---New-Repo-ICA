  ...
  return (
    <div className="px-4 py-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-primary-600 mb-2">Business Dashboard</h1>
        ...
        <div className="mt-4 md:mt-0">
          <Link 
            ...
            className="inline-flex items-center justify-center px-5 py-2.5 border border-transparent text-sm font-medium rounded-md text-white bg-primary-600 shadow-md hover:bg-primary-700 transition-colors duration-200"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        <div className="bg-white dark:bg-dark-surface rounded-xl shadow-card dark:shadow-card-dark p-6 border-l-4 border-primary-600 transform transition-transform hover:scale-105 duration-300">
          ...
          <p className="text-4xl font-bold text-primary-600 dark:text-primary-400">{stats.totalPods}</p>
      ...
      <div className="bg-white dark:bg-dark-surface rounded-xl shadow-card dark:shadow-card-dark overflow-hidden mb-10">
        <div className="flex justify-between items-center p-6 border-b border-gray-200 dark:border-dark-border">
          <div className="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-primary-600 dark:text-primary-400 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {recentPods.length > 0 ? (
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200 dark:divide-dark-border">
              ...
              <tbody className="bg-white dark:bg-dark-surface divide-y divide-gray-200 dark:divide-dark-border">
                {recentPods.map((pod) => (
                  <tr key={pod.id} className="hover:bg-primary-50 dark:hover:bg-primary-900/10 transition-colors duration-150">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-primary-600 dark:text-primary-400 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className="px-3 py-1 inline-flex text-sm font-medium rounded-md bg-primary-50 text-primary-700 dark:bg-primary-900/30 dark:text-primary-300">
                        {pod.podCode}
                      </span>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
          ...
          <div className="text-center py-12">
            ...
            <Link 
              href="/dashboard/create-pod" 
              className="inline-flex items-center px-5 py-2.5 border border-transparent text-sm font-medium rounded-md text-white bg-primary-600 shadow-md hover:bg-primary-700 transition-colors duration-200"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z" clipRule="evenodd" />
              </svg>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white dark:bg-dark-surface rounded-xl shadow-card dark:shadow-card-dark p-6 transform transition-all hover:shadow-lg duration-300 flex flex-col items-center text-center">
          ...
          <Link 
            href="/dashboard/create-pod" 
            className="mt-auto inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-primary-600 hover:bg-primary-700 w-full transition-colors duration-200"
          >
            Create New Pod
          </Link>
        </div>
        ...
        <div className="bg-white dark:bg-dark-surface rounded-xl shadow-card dark:shadow-card-dark p-6 transform transition-all hover:shadow-lg duration-300 flex flex-col items-center text-center">
          ...
          <Link 
            href="/dashboard/pods" 
            className="mt-auto inline-flex items-center justify-center px-4 py-2 border border-primary-600 text-sm font-medium rounded-md text-primary-600 bg-white hover:bg-primary-50 dark:bg-dark-surface dark:hover:bg-primary-900/10 dark:text-primary-400 w-full transition-colors duration-200"
          >
            View All Pods
          </Link>
        </div>
