        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1">
            ...
            <p className="text-xl text-gray-600 mb-10">
              SplitIOU makes group payments simple, transparent, and hassle-free. Whether you&apos;re dining out, traveling, or sharing household expenses.
            </p>
      ...
      <section id="problem" className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-white rounded-3xl shadow-lg my-12">
        ...
        <div className="mt-12 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            SplitIOU transforms this experience with a simple platform that lets businesses create detailed payment pods with multiple items, and allows customers to easily join and settle their fair share.
          </p>
        </div>
      </section>
